...
func (c *cli) setupConfig(
	...
	c.cfg.ServerTLSConfig.KeyFile =
		viper.GetString("server-tls-key-file")
	...
	if c.cfg.ServerTLSConfig.CertFile != "" &&
		...
		c.cfg.Config.ServerTLSConfig, err =
			config.SetupTLSConfig(c.cfg.ServerTLSConfig)
	...
	if c.cfg.PeerTLSConfig.CertFile != "" &&
		...
		c.cfg.Config.PeerTLSConfig, err =
			config.SetupTLSConfig(c.cfg.PeerTLSConfig)
